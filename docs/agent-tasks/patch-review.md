...
For small diffs, a local model (Gemma/Qwen) can be used as a first-pass reviewer:
...
- If using a local model, keep the diff small and verify any finding manually.
